...
class GroqService:
    ...
    def __init__(self, vector_store_service: VectorStoreService):
        if not GROQ_API_KEYS:
            raise ValueError(
                "No Groq API keys configured. Set GROQ_API_KEYS (and optionally GROQ_API_KEY_2, GORQ_API_KEY_3, ...) in .env"
    ...
    def _build_prompt_and_messages(
        ...
        try:
            ...
            if context_docs:
                ...
                context_sources = [doc.metadata.get("source","unkown") for doc in context_sources]
        ...
        logger.info("[PROMPT] System message length: %d chats | History paris: %d | Question: %.100s",
